...
public class SoundManager{
	...
	private static CrocodileActivity mContext;
	 ...
	 *
	 * @param winteriscomingActivity The Application context
	 */
	public static  void initSounds(CrocodileActivity CrocodileActivity)
	{
		 mContext = CrocodileActivity;
	...
	{
		mSoundPoolMap.put(1, mSoundPool.load(mContext, R.raw.chompx3, 1));
